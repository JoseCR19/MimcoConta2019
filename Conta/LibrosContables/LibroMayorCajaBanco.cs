...
{
    public partial class LibroMayorCajaBanco : Form
    {
        List<TipoAsiento> objListTipoAsiento = new List<TipoAsiento>();
        List<Moneda> objListMoneda = new List<Moneda>();
        public static List<ContaDTO.LibroDiario> objListaLibroMayorCajaBanco = new List<ContaDTO.LibroDiario>();
        MonedaDAO objMonedaDao;
        AsientoDAO objAsientoDao;
        public LibroMayorCajaBanco()
        {
            InitializeComponent();
            this.ControlBox = false;
            this.Text = "Libro Mayor Caja y Banco";
        ...
        {
            this.Hide();
            ContabilidadMenu.formContabilidad.setEnabledItems("LMCB");
        }

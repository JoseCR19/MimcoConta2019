...
{
    public partial class AsientoCVoucher : Form
    {
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < objListaAsientoDetalle.Count; i++)
            {
                ...
                objListaAsientoDetalle[i].FechaDoc = objVoucher.FechaEmision.ToString("dd/MM/yyyy");
                objListaAsientoDetalle[i].Anexo = objVoucher.Ruc;
            ...
            RegistrarVoucher formAsient = new RegistrarVoucher();
            formAsient.Show();
            this.Close();
        }
        ...
        private void btn_SaveData_Click(object sender, EventArgs e)
        {
            ...
            objAsientoDetalle.FechaDoc = objVoucher.FechaEmision.ToString("dd/MM/yyyy");
            objAsientoDetalle.FechaVcto = objVoucher.FechaPago.ToString("dd/MM/yyyy");
